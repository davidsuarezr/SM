...
FermionFields[[6]] = {CL , 1,        cl,    0, 1,  1,  3, -1};
FermionFields[[7]] = {CR , 1,  conj[cr],    0, 1,  1,  2, -1};
FermionFields[[8]] = {CL2 , 1,        cl2,    0, 1,  1,  6, -1};
FermionFields[[9]] = {CR2 , 1,  conj[cr2],    0, 1,  1, -1, -1};
FermionFields[[10]] = {NR,  2,  conj[nr],    0, 1,  1, -5,  1};
...
ScalarFields[[6]] =  {S,   1,          s,    0, 1,  1,  5,  1};
...
LagCL = - mCL conj[CL].CL;
LagCR = - mCR conj[CR].CR;
LagCL2 = - mCL2 conj[CL2].CL2;
LagCR2 = - mCR2 conj[CR2].CR2;
...
LagY = - Y CL.CR.conj[S] - Y1 conj[ET].l.CR - Y2 CL.NR.SG - Y3 CL2.CR2.conj[S] - Y4 conj[ET2].l.CR2 - Y5 CL2.NR.SG2;
